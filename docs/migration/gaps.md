...
**Backend**
- [ ] 1. OAuth 2.1 server (`/oauth/authorize|token|register` + `.well-known`) — sin esto Claude Desktop/MCP-OAuth se rompe
...
- [ ] 7. Audit log interceptor (tabla existe, nadie escribe)
