...
Use the [bug report template](https://github.com/thedavos/2post/issues/new?template=bug_report.yml) on GitHub. Include:
...
Use the [feature request template](https://github.com/thedavos/2post/issues/new?template=feature_request.yml) on GitHub.
